...
export function SellerSubmissionForm() {
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setState("success");
      setMessage(
        "Car details received. FastDeal will contact you for the next steps."
      );
    } catch (error) {
      setState("error");
      setMessage(
        error instanceof Error ? error.message : "Unable to submit car details."
      );
    }
  }
  ...
  return (
    <form className="seller-form" onSubmit={handleSubmit}>
      <p className="form-help">
        Only four fields are required. Adding more details helps FastDeal
        prepare a stronger listing — but everything below the required block
        is optional and can be filled later.
      </p>

      <div className="seller-essentials">
        <div className="seller-essentials-head">
          <span>Required</span>
          <small>Takes about 30 seconds</small>
        </div>
        <div className="field-grid">
          ...
          <label className={showOtherMake ? "" : "full-field"}>
      ...
      <OptionalSection title="Contact details">
        <div className="field-grid">
          <label>
      ...
      <OptionalSection title="About the car">
        <div className="field-grid">
          <label>
      ...
      <OptionalSection title="Specifications">
        <div className="field-grid">
          <label>
      ...
      <OptionalSection title="Condition and history">
        <div className="field-grid">
          <label>
          ...
          <label>
            ...
            <input
              ...
              placeholder="Single local owner after import"
            />
          </label>
          <label>
          ...
          <label>
            ...
            <input
              ...
              placeholder="Registered in Rwanda"
            />
          </label>
          <label>
      ...
      <OptionalSection title="Features and documents">
        <div className="field-grid">
          <label className="full-field">
      ...
      <OptionalSection title="Service package and scheduling">
        <div className="field-grid">
          <label>
          ...
          <label>
            ...
            <input
              name="preferred_day"
              placeholder="Monday, Friday, weekend..."
            />
          </label>
          <label>
          ...
          <label className="full-field">
            ...
            <input
              ...
              placeholder="Exact location or nearby landmark"
            />
          </label>
        </div>
      </OptionalSection>
      ...
      <label className="seller-terms">
        ...
        />
        <span>
          I confirm the details above are accurate and I agree to FastDeal
          Rwanda&apos;s <a href="/contact">terms of service</a> and{" "}
      ...
      <button
        type="submit"
        disabled={state === "sending" || !acceptedTerms}
      >
...
function OptionalSection({
  ...
  return (
    <details className="seller-optional">
      <summary>
        <span className="seller-optional-title">{title}</span>
        <span className="seller-optional-flag">Optional</span>
        <ChevronIcon />
      </summary>
      <div className="seller-optional-body">{children}</div>
    </details>
  );
}
...
function ChevronIcon() {
  return (
    <svg
      aria-hidden="true"
      className="seller-optional-chevron"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
      strokeWidth="2.4"
